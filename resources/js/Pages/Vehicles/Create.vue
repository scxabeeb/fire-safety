...
const createDriver = () => {
    axios.post(route('staff.store'), {
        ...
        position: 'Driver', // Auto-assign position
        shift: 'Morning', // Default shift or could be null? Validation says nullable if I recall? Let's check controller. 
        // Controller: 'shift' => 'nullable|string|max:255'
    }, {
        headers: {
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Register New Vehicle</h2>
        </template>
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div>
                                ...
                                <TextInput id="vehicle_type" type="text" class="mt-1 block w-full"
                                    ...
                                    placeholder="e.g. Fire Truck, Ambulance" />
